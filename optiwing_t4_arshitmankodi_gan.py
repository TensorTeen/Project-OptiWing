# -*- coding: utf-8 -*-
"""Optiwing_T4_ArshitMankodi_GAN.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1YkK36C-xpS0YhwH6YiuAllW8-TPs8JRU

## **DCGAN for generating synthesis handwritten digit images by using MNIST dataset in PyTorch**
...
4. In a train process, the generator tries to generate synthetic images to deceive the discriminator while the discriminator tries to predict whether the image is real or fake. Through this series of processes, we can obtain images that are close to the real images.
...
"""Plotting loss vs iterations graph"""
...
"""images of fake and real digits
